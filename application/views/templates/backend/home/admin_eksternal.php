                    ...
                    <div class="row">
                      <div class="col-md-6 col-xs-6">
                        ...
                        <div class="small-box bg-blue">
                          <div class="inner">
                            <h3><sup style="font-size: 16px"><?php echo'Jumlah Mahasiswa' ?><br><?php echo $instansi?></sup></h3>

                            <p>Total:  <?php echo $jumlahmhs?> Mahasiswa</p>
                          </div>
                          <div class="icon">
                            <i class="fa fa-user-md"></i>
                          </div>
                          <a href="<?php echo base_url();?>diklat_eksternal/mahasiswa" class="small-box-footer">
                      ...
                      <div class="col-md-6 col-xs-6">
                        ...
                        <div class="small-box bg-yellow">
                          <div class="inner">
                            <h3><sup style="font-size: 16px"><?php echo 'Jumlah Kegiatan Diklat' ?> <br><?php echo $instansi?></sup></h3>

                            <p>Total <?php echo $jumlah_keg?> Kegiatan Diklat</p>
                          </div>
                          <div class="icon">
