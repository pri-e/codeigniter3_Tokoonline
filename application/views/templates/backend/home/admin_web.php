                ...
                <div class="col-md-12" style="word-wrap:break-word;">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-xs-6">
                        ...
                        <div class="small-box bg-yellow">
                          <div class="inner">
                            <h3><sup style="font-size: 20px"><?php echo 'Article Post count' ?></sup></h3>

                            <p>Jumlah artikel <?php echo $jumlah_post?></p>
                          </div>
                          <div class="icon">
                            <i class="fa fa-file-text"></i>
                          </div>
                          <a href="<?php echo base_url('artikel/berita');?>" class="small-box-footer">
                            More info <i class="fa fa-arrow-circle-right"></i>
                          </a>
                        </div>
                      </div>                  
                  ...
                  <script type="text/javascript">
                    $(document).ready(function(){
                      ...
                      var options = {
                          ...
                          title: {
                                text: 'Jumlah Posting Artikel per Bulan'
                          },
                          subtitle: {
                              text: th
                          },
                          ...
                          yAxis: {
                            title: {
                                text: 'Jumlah Post Artikel per bulan'
                            }
                          },
                          legend: {
                              enabled: false
                          ...
                          plotOptions: {
                              series: {
                                  ...
                                  dataLabels: {
                                      enabled: true,
                                      format: '{point.y:.f} Artikel'
                                  }
                              }
                          },
                          tooltip: {
                              headerFormat: '<span style="font-size:11px">{series.name}</span><br>',
                              pointFormat: '<span style="color:{point.color}">{point.name}</span>: <b>{point.y:.f}  Artikel</b>.!<br/>'
                          },
                          series: [{
                            name: 'Jumlah Post Artikel per bulan',
                            colorByPoint: true,
                            data:[{}]
                          }],                              
                      };
                      $.getJSON("<?php echo $base_url; ?>/home/post_json", function(json) {
