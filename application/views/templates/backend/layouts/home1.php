      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Jumlah Pasien JKN</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Klaim terkirim Online</span>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){    
    ...
    var options = {
          ...
          title: {
              text: 'Klaim dan jumlah Pasien BPJS'
          },
          subtitle: {
              text: 'tahun'
          },     
    ...
    $.getJSON("<?php echo $base_url; ?>index.php/home/json_klaim_pxbpjs", function(json) {
        options.series[{}] = json;
